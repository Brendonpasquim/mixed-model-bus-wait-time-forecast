...
title("Tempos de Espera entre Pontos (Todos)", xlab="Sequência de Pontos de Parada", ylab="Tempo de Espera (Segundos)")
```
...
graph_m3_forecast_1_cycle <- ggplot(dados1, aes(x = Seq)) +
      ...
      labs(title = "Previsões com Intervalos de Confiança", x = "Sequência de Pontos de Parada", y = "Tempo de Espera (Segundos)") + theme_minimal()
